from l5x_lint.checks.e003_missing_aoi import e003_missing_aoi
...
def test_builtin_opcode_no_diagnostic():
    ...
    result = e003_missing_aoi(r, table, _loc())
    assert result == []
