from l5x_lint.checks.w003_output_never_driven import w003_output_never_driven
...
def test_input_and_output_no_diagnostic():
    ...
    result = w003_output_never_driven(r, table, _loc())
    assert result == []


def test_input_only_emits_w003():
