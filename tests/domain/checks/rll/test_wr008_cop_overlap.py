from l5x_lint.domain.checks.rll.wr008_cop_overlap import wr008_cop_overlap
            ...
            _make_rung(
                ...
                [
                    Instruction(
                        opcode="COP",
                        operands=[
                            Operand(value="SourceTag"),
                            Operand(value="DestTag"),
                            Operand(value="10"),
                        ],
                    ),
                ],
            ...
            _make_rung(
                ...
                [
                    Instruction(
                        opcode="COP",
                        operands=[
                            Operand(value="MyArr[0]"),
                            Operand(value="MyArr[1]"),
                            Operand(value="10"),
                        ],
                    ),
                ],
