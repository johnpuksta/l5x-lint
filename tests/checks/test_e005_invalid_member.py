from l5x_lint.checks.e005_invalid_member import e005_invalid_member
...
def test_valid_member_no_diagnostic():
    ...
    result = e005_invalid_member(r, table, _loc())
    assert result == []


def test_invalid_member_emits_e005():
    dt = DataType(name="MyUDT", family="NoFamily", class_="",
                  members=[Member(name="Field1", data_type="DINT")])
