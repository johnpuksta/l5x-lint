from l5x_lint.checks.w005_shadowed_tag import w005_shadowed_tag
...
def test_no_shadowing():
    ...
    result = w005_shadowed_tag(Routine(name="Main", type="RLL"), table, _loc())
    assert result == []
