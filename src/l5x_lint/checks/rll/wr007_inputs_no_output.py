from l5x_lint.checks._codes import WR007
...
_OUTPUT_OPS: frozenset[str] = frozenset({
    "OTE", "OTL", "OTU", "TON", "TOF", "RTO",
    "CTU", "CTD", "RES", "MOV", "ADD", "SUB", "MUL", "DIV",
    "CPT", "CLR", "COP", "CPS", "FAL", "FSC",
    "MSG", "JSR", "JXR", "GSV", "SSV",
})
    ...
    for rung in routine.rll_rungs:
        ...
        if state.has_input and not state.has_output:
            result.append(Diagnostic(
                code=WR007.code, severity=WR007.severity,
                location=Location(
