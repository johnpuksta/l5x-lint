from l5x_lint.checks.st.ws111_literal_overflow import ws111_literal_overflow
...
def test_small_literal_no_diagnostic():
    ...
    diags = ws111_literal_overflow(r, SymbolTable(), Location(program="P", routine="Test"))
    assert diags == []
